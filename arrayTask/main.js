...
// 1- Favorite Food (5)
let favoriteFood = ["Tajen", "Mansaf", "Kabab"];
// 2- Favorite Sport (3)
let favoriteSport = ["BasketBall", "Swimming", "Walking"];
// 3- Favorite Movie (4)
let favoriteMovie = ["Wednesday", "Squid Game"];
...
console.log(firstOfArray(["t", "u", "g", "x"])); // => "t"
...
console.log(lastOfArray([1, 4, 5])); // => 5
console.log(lastOfArray(["t", "u", "g", "x"])); // => "x"
...
*/
var array2 = [5, 9, -7, 3.5];
console.log(array2.push("Bushra"));
console.log(array2.unshift("JS"));
